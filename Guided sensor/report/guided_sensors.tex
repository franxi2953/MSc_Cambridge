...
those technologies open-source will assure that they stay for individuals and by 
individuals.

Here, we provide two examples of open-source DIY sensors. First, we will improve 
the accurancy of a commercial temperature sensor by customazing the current design 
with analog amplification circuits; a calibration protocol will also be provided. 
This will be a proof of example of how open-source technology allows for continuous 
improvement and refining by the community. Secondly, we will construct from scratch 
a individual-use pulse meter starting simply from the understanding of the mechanisms 
needed, providing an example of DIY technology.
   ...
   \subsection{Sensor design}
      \subsubsection{Electronic diagram}
         ...
         \begin{enumerate}
            ...
            \item The amplification circuit, composed of an operational amplifier working as a voltage amplifier, and two interchangeable
      ...
      to ensure insulation, ensuring that the ceramic surface remained exposed to facilitate thermal exchange.
